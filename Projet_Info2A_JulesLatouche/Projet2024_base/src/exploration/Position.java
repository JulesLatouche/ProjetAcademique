...
public class Position
{
    ...
    /**
     * Retourne la position suivante dans le parcours gauche -> droite haut -> bas. Cette position peut être invalide si la position courante est la position en bas à droite
     * ou qu'elle est elle-même invalide
     * @return
     */
